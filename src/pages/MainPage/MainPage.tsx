  ...
  return (
    <div className={styles.container}>
      <div className={styles.row}>
        <Block blockBackgroundType={BlockType.BLOCK1_LR_TB}>
          <span><h1>Who are we?</h1></span>
        </Block>
        <Block blockBackgroundType={BlockType.BLOCK2_RL_BT}>
          <span>We are <b>TheBestCompany</b>. We produce the best things and make our customers happy.</span>
        </Block>
      </div>

      <div className={styles.row}>
        <Block blockBackgroundType={BlockType.BLOCK3_LR_BT}>
          <span>We produce the best products on the market, so all our competitors are left behind.</span>
        </Block>
        <Block blockBackgroundType={BlockType.BLOCK4_RL_TB}>
          <span><h1>What we do?</h1></span>
        </Block>
      </div>

      <div className={styles.row}>
        <Block blockBackgroundType={BlockType.BLOCK5_LR_TB}>
          <span><h1>How to contact us?</h1></span>
        </Block>
        <Block blockBackgroundType={BlockType.BLOCK6_RL_BT}>
